...
export const multiIdentity = [
  {
    label: "Filmmaker & Director",
    description:
...
export const whyTheDisciplinesConnect = [
...
export const timeline: TimelineItem[] = [
  ...
  },
  {
    ...
    title: "From storyteller to strategist and public communicator",
    description:
      "Moves beyond execution into designing narratives, shows, and initiatives that have a clear strategic spine.",
  },
  {
    year: "Astrology & guidance",
    title: "Listening more deeply to people’s questions",
    description:
  ...
  {
    year: "AI & public tools",
    title: "Turning ideas into utilities",
    description:
